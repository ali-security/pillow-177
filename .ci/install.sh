...
sudo bash -c 'echo "deb http://archive.ubuntu.com/ubuntu/ jammy-backports main ubuntu restricted universe multiverse" > /etc/apt/sources.list'
# sudo bash -c 'echo "deb http://security.ubuntu.com jammy-backports main restricted universe multiverse" > /etc/apt/sources.list'
